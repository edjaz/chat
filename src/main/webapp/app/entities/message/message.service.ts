...
export class MessageService {
    ...
    private convertItemFromServer(message: Message): Message {
        ...
        copy.created = this.dateUtils
            .convertDateTimeFromServer(message.created);
        copy.updated = this.dateUtils
            .convertDateTimeFromServer(message.updated);
        copy.sent = this.dateUtils
            .convertDateTimeFromServer(message.sent);
        return copy;
    }
    ...
    private convert(message: Message): Message {
        ...
        copy.updated = this.dateUtils.toDate(message.updated);
