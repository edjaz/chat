...
public class MessageResourceIntTest {
    ...
    private static final MessageStatus DEFAULT_STATUS = MessageStatus.IN_PROGRESS;
    private static final MessageStatus UPDATED_STATUS = MessageStatus.DONE;
    ...
    private static final Instant DEFAULT_SENT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_SENT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getUpdated()).isEqualTo(DEFAULT_UPDATED);
    ...
    public void getAllMessages() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sent").value(hasItem(DEFAULT_SENT.toString())));
    }
    ...
    public void getMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages/{id}", message.getId()))
            ...
            .andExpect(jsonPath("$.sent").value(DEFAULT_SENT.toString()));
    }
    ...
    public void updateMessage() throws Exception {
        ...
        assertThat(testMessage.getUpdated()).isEqualTo(UPDATED_UPDATED);
