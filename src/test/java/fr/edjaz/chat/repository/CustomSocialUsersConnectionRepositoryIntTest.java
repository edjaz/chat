...
import fr.edjaz.chat.domain.SocialUserConnection;
...
public class CustomSocialUsersConnectionRepositoryIntTest {
    ...
    private void assertNewConnection(Connection<TestFacebookApi> connection) {
        ...
        assertEquals("http://facebook.com/john.doe", connection.getProfileUrl());
        assertEquals("http://facebook.com/john.doe/picture", connection.getImageUrl());
    ...
    private void assertFacebookConnection(Connection<TestFacebookApi> facebook) {
        ...
        facebook.sync();
        assertEquals("John Doe", facebook.getDisplayName());
        assertEquals("http://facebook.com/john.doe", facebook.getProfileUrl());
        assertEquals("http://facebook.com/john.doe/picture", facebook.getImageUrl());
    }
    ...
    private static class TestFacebookApiAdapter implements ApiAdapter<TestFacebookApi> {
        ...
        private String profileUrl = "http://facebook.com/john.doe";

        private String profilePictureUrl = "http://facebook.com/john.doe/picture";
        ...
        public UserProfile fetchUserProfile(TestFacebookApi api) {
            return new UserProfileBuilder().setName(name).setEmail("keith@interface21.com").setUsername("john.doe").build();
        }
